  ...
  return (
    <div className={styles.container}>
      ...
      <button onClick={scrollToTop} className={styles.scrollToTopButton}>
        ...
        <a href="#company" className={styles.navItem}>회사소개</a>
        <a href="#appearance" className={styles.navItem}>회사모습</a>
        <a href="#business" className={styles.navItem}>주요업무</a>
        <a href="#location" className={styles.navItem}>찾아오시는 길</a>
      ...
      <section id="appearance" className={styles.section}>
        <h1>회사모습</h1>
        <p>
          창의력과 혁신이 살아 숨쉬는 공간. 우리의 사무실은 팀원들이 자유롭게 아이디어를 교환하고,
          더 나은 미래를 꿈꾸는 곳입니다. 함께하는 즐거움이 가득한 공간을 확인해보세요.
        </p>
      ...
      <section id="business" className={styles.section}>
        <h1>주요업무</h1>
        <p>
          단순한 면접 준비를 넘어, 최고의 결과를 낼 수 있는 완벽한 솔루션을 제공합니다. 
          우리 서비스는 사용자 맞춤형으로 설계되어, 누구나 자신감을 얻고 성공할 수 있도록 도와줍니다.
        </p>
      ...
      <section id="location" className={styles.section}>
        <h1>찾아오시는 길</h1>
        <p>
          서울 서초구 강남구 서초대로 77길 41 4층에 위치한 우리의 사무실은 창의적인 분위기로 가득 찬 공간입니다. 
          언제든 방문해 함께 이야기를 나눠보세요!
        </p>
        <img src={mapImg} alt="지도 이미지" className={styles.image} />
      </section>
    </div>
  );
}
