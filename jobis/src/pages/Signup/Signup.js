...
function Signup() {
  ...
  const handlePhoneCheck = async () => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:8080/users/checkPhoneNumber",
        {
          phoneNumber,
        }
      );
  ...
  const checkDuplicateEmail = async () => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:8080/users/checkEmail",
        {
          email,
        }
      );
  ...
  const handleSendVerificationEmail = async () => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:8080/users/sendVerificationEmail",
        {
          email,
        }
      );
  ...
  const checkDuplicateId = async () => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:8080/users/checkuserId",
        {
          users: userId,
        }
      );
